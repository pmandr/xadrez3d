...
/**
 * This code was freely adapted from the original C code
 * (http://www.xmission.com/~nate/index.html). Some methods are not supported,
 * but it now supports multiple textures, and some bugs on parsing Wavefront
 * files were fixed. Please contact the author (fpaulovich@gmail.com) if you
...
public class Loader {
    ...
    /**
     * "unitize" a model by translating it to the origin and scaling it to fit
     * in a unit cube around the origin.
     *
     ...
     * facet normal. This tends to preserve hard edges. The angle to use depends
    ...
    public void vertexNormals(float angle) throws IOException {
         ...
         */
        this.numnormals = this.numtriangles * 3; /*
    ...
    /**
     * Generates texture coordinates according to a spherical projection of the
     * texture map. Sometimes referred to as spheremap, or reflection map
     * texture coordinates. It generates these by using the normal to calculate
     * where that vertex would map onto a sphere. Since it is impossible to map
     * something flat perfectly onto something spherical, there is distortion at
    ...
    private void readOBJ(File file) throws IOException {
        ...
        /*
         * make a first pass through the file to get a count of the number of
    ...
    private void secondPass(File file) throws IOException {
         ...
         */
        int numtexcoords_aux;		/*
         * number of texcoords in model
         */
        int numtriangles_aux;		/*
    ...
    private int findMaterial(String name) {
         ...
         * material (0).
         */
        Logger.getLogger(Loader.class.getName()).log(Level.WARNING,
    ...
    /**
     * First pass at a Wavefront OBJ file that gets all the statistics of the
     * model (such as #vertices, #normals, etc).
     *
     * @param file The file containing the Wavefront model.
     * @throws IOException
     */
    ...
    /**
     * Writes a model description in Wavefront format to a file (not
     * implemented).
     *
